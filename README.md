...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=oumas3&label=Profile%20Views&color=d63384&style=for-the-badge" alt="Profile Views"/>
  &nbsp;
  <img src="https://img.shields.io/github/followers/oumas3?style=for-the-badge&color=c2185b&labelColor=880e4f&logo=github" alt="Followers"/>
</div>

<br/>

<div align="center">
  <a href="https://linkedin.com/in/oumaima-o-5009741b4">
...
```python
class Oumaima:
    name     = "Oumaima Ouayres"
    role     = "AI & Software Engineer"
    degree   = "Master's in Data Science"
    passion  = ["Deep Learning", "NLP", "Generative AI"]
    contact  = "ouayresbusiness@gmail.com"
...
**🌿 Hybrid CVAE + DDPM**  
Generative + classification pipeline for plant disease image recognition  
`Python` `PyTorch` `CVAE` `DDPM`  
[![GitHub](https://img.shields.io/badge/View%20Repo-181717?style=flat-square&logo=github)](https://github.com/oumas3/CVAE_DDPM_PLANT_IDENTIFICATION)

</td>
<td width="50%">

**🎙️ Adversarial Attacks on TD-SV**  
Embedding-level attacks on speaker verification systems  
`Python` `PyTorch` `ECAPA-TDNN` `WavLM`  
[![GitHub](https://img.shields.io/badge/View%20Repo-181717?style=flat-square&logo=github)](https://github.com/oumas3/TDSV_SYSTEMS_ECAPA_WAVLM)
...
Automatic summarization of scientific papers using NLP  
`Python` `Flask` `T5` `BART`  
[![GitHub](https://img.shields.io/badge/View%20Repo-181717?style=flat-square&logo=github)](https://github.com/oumas3/emotion_imp)

</td>
<td width="50%">

**😊 Siamese Network for Emotion Recognition**  
Deep metric learning for facial emotion recognition  
`Python` `PyTorch` `CNN` `Metric Learning`  
[![GitHub](https://img.shields.io/badge/View%20Repo-181717?style=flat-square&logo=github)](https://github.com/oumas3/siamese_net_implementation)
